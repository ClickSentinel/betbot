...
class TestReactionBatchingSystem:
    ...
    @pytest.mark.asyncio
    async def test_single_reaction_bet_sticks(self, betting_cog, mock_data, mock_user, mock_message, mock_channel):
    ...
    @pytest.mark.asyncio
    async def test_rapid_multiple_reactions_only_final_sticks(self, betting_cog, mock_data, mock_user, mock_message, mock_channel):
        ...
        with patch('cogs.betting.load_data', return_value=mock_data), \
            ...
            for emoji in reactions:
                ...
                payload.channel_id = 888
                payload.emoji = Mock()
                payload.emoji.__str__ = lambda e=emoji: e
            ...
            assert mock_data["balances"]["123"] == 900  # 1000 - 100 (not multiple deductions)
    ...
    @pytest.mark.asyncio
    async def test_insufficient_balance_removes_all_reactions(self, betting_cog, mock_data, mock_user, mock_message, mock_channel):
    ...
    @pytest.mark.asyncio
    async def test_betting_locked_removes_reactions(self, betting_cog, mock_data, mock_user, mock_message, mock_channel):
    ...
    @pytest.mark.asyncio
    async def test_reaction_removal_cancels_bet(self, betting_cog, mock_data, mock_user):
    ...
    @pytest.mark.asyncio
    async def test_timer_cancellation_on_new_reaction(self, betting_cog, mock_data, mock_user, mock_message, mock_channel):
