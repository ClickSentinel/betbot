...
class TestMessagingMathValidation:
    ...
    def test_balance_display_math(self, test_data):
        ...
        assert available_balance == 1500, f"Available balance should be 1500, got {available_balance}"
    ...
    def test_bet_placement_math_validation(self, test_data):
        ...
        assert actual_new_balance == expected_new_balance, (
        ...
        assert bet["amount"] == bet_amount, f"Bet amount should be {bet_amount}, got {bet['amount']}"
    ...
    def test_betall_amount_calculation(self, test_data):
        ...
        for balance in test_cases:
            ...
            available_balance = test_data["balances"][user_id]
            assert available_balance == balance, f"Available balance should equal set balance: {balance}"
            ...
            assert final_balance == 0, f"Balance should be 0 after betall, got {final_balance}"
            
            # Bet amount should equal original balance
            bet = test_data["betting"]["bets"][user_id]
            assert bet["amount"] == balance, f"Bet amount should be {balance}, got {bet['amount']}"
    ...
    def test_betting_math_edge_cases(self, test_data):
        ...
        assert test_data["balances"][user_id] == 0, "Balance should be 0 after betting everything"
    ...
    def test_multi_round_balance_tracking(self, test_data):
        ...
        assert actual_balance == expected_balance_after_loss, (
