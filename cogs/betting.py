...
from config import (
    SEPARATOR_EMOJI, CONTESTANT_EMOJIS,
    ...
    TITLE_INVALID_BET_FORMAT, TITLE_BET_PLACED,
    TITLE_CANNOT_CLOSE_BETS, TITLE_BETTING_CHANNEL_SET, TITLE_TIMER_TOGGLED,
    TITLE_CURRENT_BETS_OVERVIEW, TITLE_BETTING_LOCKED_OVERVIEW,
