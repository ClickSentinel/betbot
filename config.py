...
MSG_BET_LOCKED = "⚠️ Betting is currently locked. Please wait for a winner to be declared."
...
MSG_INTERNAL_ERROR_LOCKED = "❌ Internal error: Betting state is inconsistent (locked but not open)."
