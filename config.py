...
DESC_GENERAL_HELP = (
    ...
    "**⚠️ Note for users:** Admins open betting rounds using `!openbet`. Each open round posts its own live message and timer, so reaction betting appears on the dedicated message for that round."
)
DESC_ADMIN_HELP = (
